    ...
    if(rbvtrPacket->getdesAddress()==getSelfIPAddress())
           {
                ...
                map<IPvXAddress, int>::iterator iter = RElist.find(rbvtrPacket->getdesAddress());
                if (iter != RElist.end())
                {
                    //make the counter +1
                ...
                {
                    routingRoad.removeRoadTable(rbvtrPacket->getdesAddress());
                    iter->second=0;
                }
           }
         else
